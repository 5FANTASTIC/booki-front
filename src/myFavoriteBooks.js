        ...
        <div class='books'>
          {
            ...
            <>
              <center><h3 class='AboutUsH3'>  Favorite Books </h3></center>
                    ...
                    return (
                      <>
                        <tr>
                          ...
                          <td class='marginTop'>{item.title}</td>
                          <td class='marginTop'>{item.authors}</td>
                          <td class='marginTop'><Button variant="light" className='buttonTrash' onClick={() => this.remove(index)}>
                            <IconContext.Provider
                              value={{ color: "#02192d", size: '27', className: "trashIcon" }}
                            >
                              <div class='trashTool'>
                                < IoTrashBin />
                              </div>
                          ...
                          <td class='marginTop'><Button variant='light' className='buttonDetails' onClick={() => this.showRemainDetails(item, index)}>
                            <IconContext.Provider
                              value={{ color: "#02192d", size: '27', className: "detailsIcon" }}
                            >
                              <div class='detailsTool'>
                                < BiDetail />
                              </div>

                            </IconContext.Provider>
                          </Button></td >
                          <td class='notes marginTop'>{item.note}</td>
                        </tr>
